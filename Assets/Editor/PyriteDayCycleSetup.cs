...
public static class PyriteDayCycleSetup
{
    ...
    public static void Setup()
    {
        ...
        cyc.campBase = new[] { 7.86f, 3.0f, 3.0f, 0.70f };   // 2026-09-24 화로 7.86(Z28b) · 노란 랜턴·들고 다니는 랜턴 3.0(Z29b)   // 2026-09-24 화로 9.82 → 7.86 (Z28b, 범위 4.2 m)                // Fire_Light, Fire_Light, 랜턴 Light, 부두 뿌리 (19:45 로그)
